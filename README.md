...
3. **重试消息** - 点击右上角菜单中的重试按钮
4. **加载历史** - 滚动到顶部自动触发分页加载更早的消息
...
2. **日志查看器** - 在会话列表页面通过菜单进入日志查看器，方便调试
...
│   │   │   │   ├── activity_session_list.xml #   会话列表
