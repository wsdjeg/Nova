...
- 1591c3f chore: update Gradle config for local development
...
- 51eacd refactor: 按钮状态完全基于 session.in_progress 属性
...
- 2243df2 feat: rewrite pagination logic using Session.firstMessageIndex
...
- f7b5f47 feat: optimize scroll position handling in ChatActivity
...
- db97db2 feat: support session title from API /sessions endpoint
...
- d2939ae feat: update ApiClient to use new PUT endpoints for provider/model
- d0d88b5 fix: use new SessionManager(this) instead of getInstance(this)
- 910dd95 feat: add save button and update session API support in SessionSettingsActivity
...
- 390f3f6 fix: 恢复 SessionManager.java 中 getCurrentSession 方法并按 sessionId 排序
- 03e0f87 fix: 添加 SessionManager.getSession 方法
- 82b0be8 feat: 统一时间格式，优化会话列表功能
...
- 29804d5 docs: simplify README, remove detailed API docs
